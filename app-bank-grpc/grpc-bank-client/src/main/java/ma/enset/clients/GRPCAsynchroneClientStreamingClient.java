...
public class GRPCAsynchroneClientStreamingClient {
    public static void main(String[] args) throws IOException {
        ...
        StreamObserver<Bank.AccountTransaction> accountTransactionStreamObserver =
                bankServiceStub.submitStreamOfTransactions(new StreamObserver<Bank.PerformStreamOfTransactionsResponse>() {
                    @Override
                    public void onNext(Bank.PerformStreamOfTransactionsResponse performStreamOfTransactionsResponse) {
                        System.out.println("============= Result returned by server =================");
                        System.out.println(performStreamOfTransactionsResponse);
                        System.out.println("======================================");
                    }
                    @Override
